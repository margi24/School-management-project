...
public class TemaValidator implements Validator<Tema> {
    ...
    public void validate(Tema entity) throws ValidationException {
        ...
        if(entity.getDeadline() < 1 || entity.getDeadline() > 20) {
            throw new ValidationException("Deadlineul trebuie sa fie intre 1-20.");
        }
        if(entity.getPrimire() < 1 || entity.getPrimire() > 20) {
            throw new ValidationException("Saptamana primirii trebuie sa fie intre 1-20.");
        }
    }
}
