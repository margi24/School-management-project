...
public abstract class AbstractCrudRepository <ID, E extends HasID<ID>> implements CrudRepository<ID, E> {
    ...
    public E save(E entity) {
        ...
        return elemente.putIfAbsent(entity.getID(),entity);
    ...
    public Optional<E> delete(ID id) {
        return Optional.ofNullable(elemente.remove(id));
    }
    ...
    @Override
        ...
        public Optional<E> update (E entity){
            if (elemente.containsKey(entity.getID())) {
                elemente.put(entity.getID(), entity);
