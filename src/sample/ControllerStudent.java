...
private ObservableList<Student> observableList;
    ...
    public List<Student>getDataStudents(){
        ...
        //if(to<size)to=size;
        return this.service.getPieceDataSt(from,to);
    ...
    private Node createPageStudent(int pageIndex) {
        ...
        this.to =Math.min(from+nrRow,service.getStudentiLista().size())-1;
...
public ObservableList getList(){
    ...
    try{
        ...
        alert.setTitle("EROARE ADAUGARE");
    ...
    void clickDel(MouseEvent event) {
        try{
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("EROARE STERGERE");
            alert.setHeaderText(null);
